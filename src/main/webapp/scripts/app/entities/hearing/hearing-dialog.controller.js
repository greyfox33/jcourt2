...
angular.module('jcourt2App').controller('HearingDialogController',
    ['$scope', '$stateParams', '$modalInstance', 'entity', 'Hearing',
        function($scope, $stateParams, $modalInstance, entity, Hearing) {
        ...
        var onSaveFinished = function (result) {
            $scope.$emit('jcourt2App:hearingUpdate', result);
