package com.ots.jcourt2.web.rest;

import com.ots.jcourt2.Application;
import com.ots.jcourt2.domain.Hearing;
import com.ots.jcourt2.repository.HearingRepository;
...
import com.ots.jcourt2.domain.enumeration.Statuscode;
...
public class HearingResourceTest {
    ...
    private static final String DEFAULT_JUDGE = "SAMPLE_TEXT";
    private static final String UPDATED_JUDGE = "UPDATED_TEXT";
    ...
    public void initTest() {
        ...
        hearing.setJudge(DEFAULT_JUDGE);
    ...
    public void createHearing() throws Exception {
        ...
        assertThat(testHearing.getJudge()).isEqualTo(DEFAULT_JUDGE);
    ...
    public void getAllHearings() throws Exception {
        ...
        restHearingMockMvc.perform(get("/api/hearings"))
                ...
                .andExpect(jsonPath("$.[*].judge").value(hasItem(DEFAULT_JUDGE.toString())))
    ...
    public void getHearing() throws Exception {
        ...
        restHearingMockMvc.perform(get("/api/hearings/{id}", hearing.getId()))
            ...
            .andExpect(jsonPath("$.judge").value(DEFAULT_JUDGE.toString()))
    ...
    public void updateHearing() throws Exception {
        ...
        hearing.setJudge(UPDATED_JUDGE);
        ...
        assertThat(testHearing.getJudge()).isEqualTo(UPDATED_JUDGE);
